...
- **A regression test is not trusted until it has been seen to fail.** The Phase 4 checkpoint's seen-mark fix was verified by reverting it and watching the new test go red first. (checkpoint)
